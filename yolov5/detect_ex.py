...
<<<<<<< HEAD:yolov5/detect_e.py

=======
detect_exit = False;
>>>>>>> 5b0d7849bf2e3caa6da032a871e0edb332ab6b3d:yolov5/detect_ex.py
...
class MicrophoneStream(object):
    credential_path = "B:\i-return-315911-61ff5455ec2a.json"
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            if re.search(r"\b(날씨)\b", transcript, re.I):
                text = TTS('오늘 서울의 날씨는 28도로 구름이 조금있어요.','./audio_stt_tts/weather.wav')
                run_wav('./audio_stt_tts/weather.wav')
                print("Exiting..")
...
if __name__ == '__main__':
    ...
    p1 = Process(target=mic)
    p1.start()
    p2 = Process(target=detect(opt=opt))
    p2.start()
